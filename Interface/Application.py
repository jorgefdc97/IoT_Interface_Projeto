...
class Subscriber:
    ...
    def on_connect(self, client, userdata, flags, rc):
        if rc == 0:
            ...
            time.sleep(3)
            self.app.refresh_temperature(10)
            time.sleep(3)
            self.app.system_on_fire()
            self.app.refresh_temperature(20)
            time.sleep(3)
            self.app.refresh_temperature(0)
            time.sleep(3)
            self.app.system_on_fire()
            self.app.refresh_temperature(15)
            time.sleep(3)
            self.app.refresh_temperature(16)
            time.sleep(3)
